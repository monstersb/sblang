...
sb_token_desc_t sb_token_desc[TK_T_COUNT] = {
    ...
    {TK_T_DIV, "DIV"},         {TK_T_EQ, "EQ"},           {TK_T_NEQ, "NEQ"},
    {TK_T_LT, "LT"},           {TK_T_LTE, "LTE"},         {TK_T_GT, "GT"},
    {TK_T_GTE, "GTE"},         {TK_T_L_AND, "L_AND"},     {TK_T_L_OR, "L_OR"},
    {TK_T_L_NOT, "L_NOT"},     {TK_T_B_AND, "B_AND"},     {TK_T_B_OR, "B_OR"},
    {TK_T_B_NOT, "B_NOT"},     {TK_T_B_XOR, "B_XOR"},     {TK_T_SEMI, "SEMI"},
    {TK_T_LPAR, "LPAR"},       {TK_T_RPAR, "RPAR"},       {TK_T_LBRACE, "LBRACE"},
    {TK_T_RBRACE, "RBRACE"},   {TK_T_K_IF, "K_IF"},       {TK_T_K_WHILE, "K_WHILE"},
    {TK_T_K_PRINT, "K_PRINT"},
};
